...
#     target_dir.append("/Users/yizezhao/PycharmProjects/ece324/sigver/signatures/name_" + str(i))
#     print(str(i))
#
#     # os.mkdir(target_dir[i-1])
# 
# # forgery data
# for i in range(1, 56):
#     forg_target_dir.append("/Users/yizezhao/PycharmProjects/ece324/sigver/signatures/name_" + str(i) + "/1")
#     print(str(i))
#
...
# #authetic data
# for i in range(1, num_of_names + 1):
#     auth_target_dir.append("/Users/yizezhao/PycharmProjects/ece324/sigver/signatures/name_" + str(i) + "/0")
#
